...
import { useInstallmentHelperFunc } from '../hooks/useHelper';
              ...
              <Col sm='11' md='11' xl='11'>
                <Row className='d-flex'>
                  ...
                  <Col sm='6' md='4' xl='4'>
                    ...
                    >
                      Due Date should be less than quote expiry date.
                    </UncontrolledTooltip>
                    <div className='item-name mt-1 ms-1'>
                      <Label for='note' className='form-label fw-bold'>
                        Due Date
                      ...
                      <CustomDatePicker
                        options={{
                          ...
                          static: false,
                          maxDate: expiryDate ? new Date(expiryDate) : null,
                        }}
                        errors={errors}
                        name={`productDetails[${nestIndex}].installments[${installIndex}].dueDate`}
                        key={`productDetails[${nestIndex}].installments[${installIndex}].dueDate-${expiryDate}`}
                        value={getValues(
