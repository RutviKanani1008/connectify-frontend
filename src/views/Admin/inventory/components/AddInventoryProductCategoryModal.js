...
const AddInventoryProductCategoryModal = ({
  ...
  return (
    <Modal
      ...
      className='modal-dialog-centered preview-dialog add-inventory-product-category-modal'
      backdrop='static'
    >
      <ModalHeader
        toggle={() =>
          setProductCategoryModal({ toggle: false, categoryName: '', id: '' })
        }
      >
...
export default AddInventoryProductCategoryModal;
