        ...
        <CardBody>
            ...
            <Col sm='12' lg='8' md='8'>
              ...
              {getValues(`productDetails[${index}].product`) && (
                <>
                  ...
                  <div>
                    {productDetails?.[index]?.paymentType === 'installment' && (
                      <Installments
          ...
          <div className='mt-1'>
            ...
            <FormField
              ...
              defaultValue={productDetails?.[index]?.product?.description || ''}
...
export default QuoteProductItemCard;
