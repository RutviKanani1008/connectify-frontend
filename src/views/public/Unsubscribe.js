...
import { useUnSubscribeAPI } from './apis/unsubscribe';
...
const Unsubscribe = () => {
  ...
  const { isLoading, unSubscribeAPI } = useUnSubscribeAPI();

  const useUnSubscribe = async () => {
    const { error } = await unSubscribeAPI({ id: query.id });
    if (!error) {
          ...
          <div className='cn-wrapper'>
            <div className='header-wrapper'>
              <div className='header-inner-wrapper'>
                ...
                <p className='normal-text'>Unsubscribe from our mailing list</p>
              </div>
            </div>
            {!unSubscribed ? (
              <SaveButton
              ...
              <h2 className='unsubscribed-text'>
                <CheckCircle />
