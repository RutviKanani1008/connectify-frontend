...
import { required, email } from '@configs/validationConstant';
// import { useGoogleReCaptcha } from 'react-google-recaptcha-v3';

const LoginSchema = yup.object().shape({
  email: yup.string().email(email('Email')).required(required('Email')),
...
const LoginCover = () => {
  ...
  const onSubmit = async (v) => {
    ...
    if (!res.error) {
      ...
      if (isRedirectUrl) {
        window.location.replace(isRedirectUrl);
          ...
          <div className='inner-wrapper hide-scrollbar'>
            <div className='cn-wrapper'>
              ...
              {/* <div className='auth-right-footer'>
                <span className='normal-text'>New on our platform? </span>
                <Link to='/register'>
