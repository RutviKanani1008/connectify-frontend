...
const UploadExcelSheetWithColumn = ({
  stepper,
  showFileError,
  setFile,
  setColumnNames,
  ...
  return (
    <>
      <div className='import-contact-upload-wrapper'>
        <div {...getRootProps({ className: 'custom-fileupload' })}>
        ...
        <ul className='fancy-ul'>
          ...
          <li className='item'>
            Don't worry you can always map the fields of the contacts in second
            step of import process.
          </li>
        </ul>
        <Button
          className=''
...
export default UploadExcelSheetWithColumn;
