...
import QuoteProductItemCard from './QuoteProductItemCard';
// ** Styles
...
import { PRODUCT_CHARGES_TYPE } from '../../../../../constant';
import AsyncContactSelect from './AsyncContactSelect';
...
const AddQuoteForm = ({
  ...
  const convertToInvoice = () => {
    history.push(`${basicRoute}/invoice/add?quote=${params?.id}`);
  };
      ...
      <Card className='invoice-preview-card invoice-form-wrapper'>
            ...
            <div className='invoice-number-date mt-md-0 mt-2'>
              ...
              <div className='d-flex align-items-center justify-content-md-end mb-1'>
                ...
                <InputGroup className='input-group-merge invoice-edit-input-group disabled'>
                  ...
                  <Input
                    ...
                    value={getValues('quoteId') || ''}
                    placeholder={getValues('quoteId')}
                    disabled
                  />
                </InputGroup>
              </div>
              <div className='d-flex align-items-center mb-1'>
                ...
                <CustomDatePicker
                  ...
                  enableTime={false}
                  onChange={(quoteDate) => {
                    setDate({ ...date, quoteDate: quoteDate[0] });
                    clearErrors('quoteDate');
                    setValue('quoteDate', quoteDate[0]);
                  }}
                  disabled={isDisabled}
                />
              </div>
              <div className='d-flex align-items-center mb-1'>
                ...
                <CustomDatePicker
                  ...
                  enableTime={false}
                  onChange={(expiryDate) => {
                    setDate({ ...date, expiryDate: expiryDate[0] });
                    clearErrors('expiryDate');
                    setValue('expiryDate', expiryDate[0]);
                  }}
                  disabled={isDisabled}
                />
              </div>
              {params.id !== 'add' && (
                <div className='d-flex align-items-center invoice__header__form__field__wp'>
                  <span className='title'>Quote Status:</span>
                  <FormField
                    name='status'
                    type='select'
                    errors={errors}
            ...
            <Col sm='12' md='6' xl='4'>
              ...
              {getValues('customer')?.isEnableBilling === false && (
                <div className='text-warning'>
                  Billing profile will be enabled for this contact on submitting
                  the quote
                </div>
              )}
            </Col>
        ...
        <div className='d-flex align-items-center justify-content-center mb-2'>
          <SaveButton
            ...
            loading={saveLoading}
            type='submit'
            name={params.id === 'add' ? 'Save Quote' : 'Update Quote'}
          />
        </div>
      </Card>
    </Fragment>
