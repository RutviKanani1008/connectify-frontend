...
const ForgotPassword = () => {
  ...
  const onSubmit = async (data) => {
    ...
    //   return;
    // }
    // const recaptchaToken = await executeRecaptcha('forget_password');
    setLoading(true);
      ...
      .then((res) => {
        if (res?.data?.response_type === 'success') {
          showToast(
            TOASTTYPES.success,
            toastId,
            'We send reset password link in your email address. In case of your email address registered with us.'
          );
          history.push(`/login`);
        } else if (res?.data?.toast === true) {
	...
	c3.2,0,6.1,0.6,9,1.7c2.8,1.2,5.3,2.8,7.4,4.8c2.1,2.1,3.8,4.5,5,7.2c0.6,1.4,1.1,2.8,1.4,4.3C309.6,75.6,306.3,76.6,303,78z'
            ...
            <div className='inner-wrapper hide-scrollbar'>
              <div className='cn-wrapper'>
                ...
                <Form
                  className='auth-form auth-forgot-password-form'
